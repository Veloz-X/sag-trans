	...
	while($row = mysqli_fetch_array($result))
	{
		$output .= '
			<tr>
				...
				<br>
				Google Play Gift Card <strong>'.$row["cantidad"].'</strong> USD US <img src="https://media.istockphoto.com/vectors/circle-flag-united-states-of-america-usa-flag-icon-vector-vector-id862664854?b=1&k=6&m=862664854&s=170x170&h=W_E5dhqpVzc5omi08b99O3JCfXKmbEbxY4jJIQi6YuE=" width="20">
				<br>
